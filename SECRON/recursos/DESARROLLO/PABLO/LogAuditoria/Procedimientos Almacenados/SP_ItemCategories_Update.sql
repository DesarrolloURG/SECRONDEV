...
CREATE OR ALTER PROCEDURE SP_ItemCategories_Update
    @CategoryId INT, @IsInactivation BIT,
...
BEGIN
    ...
    BEGIN TRY
        IF @IsInactivation = 1
            UPDATE ItemCategories SET IsActive = 0 WHERE CategoryId = @CategoryId;
        ELSE
            UPDATE ItemCategories SET CategoryCode = @CategoryCode, CategoryName = @CategoryName,
