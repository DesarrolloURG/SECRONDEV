...
SELECT * FROM (VALUES
('ACP_009', 'ACADEMICPROCESSES_COURSESPRICING_CREATE', 'PERMITE REGISTRAR NUEVAS PRECIOS DE CURSOS EN EL SISTEMA.', 'ACADEMICPROCESSES', 'CREATE'),
('ACP_010', 'ACADEMICPROCESSES_COURSESPRICING_UPDATE', 'PERMITE MODIFICAR PRECIOS DE CURSOS EN EL SISTEMA.', 'ACADEMICPROCESSES', 'UPDATE'),
('ACP_011', 'ACADEMICPROCESSES_COURSESPRICING_INACTIVE', 'PERMITE ACTIVAR/DESACTIVAR PRECIOS EN EL SISTEMA.', 'ACADEMICPROCESSES', 'INACTIVE'),
('ACP_012', 'ACADEMICPROCESSES_COURSESPRICING_EXPORT', 'PERMITE EXPORTAR LISTADOS DE PRECIOS EN EL SISTEMA.', 'ACADEMICPROCESSES', 'EXPORT')
